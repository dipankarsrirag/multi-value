    ...
    while True:
        if nextToken:
            response = mturk.list_workers_with_qualification_type(
                QualificationTypeId=qual_id, Status="Granted", NextToken=nextToken, MaxResults=100
            )
        else:
            response = mturk.list_workers_with_qualification_type(
                QualificationTypeId=qual_id, Status="Granted", MaxResults=100
            )
...
def main():
    ...
    while True:
        if nextToken:
            response = mturk.list_workers_with_qualification_type(
                QualificationTypeId=args.qual_id, Status="Granted", NextToken=nextToken, MaxResults=100
            )
        else:
            response = mturk.list_workers_with_qualification_type(
                QualificationTypeId=args.qual_id, Status="Granted", MaxResults=100
            )
