...
from model.modeling_auto import (
...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            # rationale_mask: set rationale answer span from article 1 and others 0
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if (
                        ...
                        and global_step % (args.logging_steps * 10) == 0
                    ):
                    ...
                    logger.info(
                        "Step: {}\tLearning rate: {}\tLoss: {}\t".format(
                            global_step,
                            scheduler.get_lr()[0],
                            (tr_loss - logging_loss) / args.logging_steps,
                        )
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="pfeiffer",
        help="Paper to use for pretrained adapter config.",
    )
    ...
    task_name = "coqa"
    if args.train_adapter and args.do_train:
        ...
        else:  # otherwise, add a fresh adapter
    ...
    if args.do_train:
        ...
        # )
        # dataset = DatasetDict()
        # dataset["train"] = train_dataset_hf
        # dataset["validation"] = dev_dataset
        # dataset.push_to_hub("WillHeld/coqa")
        ...
        for checkpoint in checkpoints:
            ...
            if args.train_adapter:
                ...
                for name, param in model.base_model.named_parameters():
                    if param.requires_grad:
                        print(name)
            #            if args.tada_adapter:
            #                lang_adapter_name = model.load_adapter(
            #                    args.tada_adapter,
            #                    source="hf",
            #                    load_as="tada",
            #                )
            #                model.set_active_adapters(["tada", task_name])
            #                print("test")
            model.to(args.device)
